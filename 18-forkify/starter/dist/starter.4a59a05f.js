...
},{"core-js/modules/web.immediate.js":"bzsBv","./model":"3QBkH","./views/recipeView":"3wx5k","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/searchView":"kbE4Z","./views/resultsView":"kBQ4r","./config":"2hPh4","./views/paginationView":"7NIiB","./views/bookmarksView":"1qGeA","./views/addRecipeView":"8AWnP"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const uploadRecipe = async function(newRecipe) {
    ...
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== '').map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error(`\u{26A0}\u{FE0F} Wrong ingredient format! Please use the correct format!`);
...
const KEY = 'e4e860bc-62ea-41da-a851-ed77b69b24b4';
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "\u26A0\uFE0F We could not find that recipe. Please try another one!";
    _message = '';
...
class ResultsView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "\u26A0\uFE0F No recipes found for your query! Please try again!";
    _message = '';
    _generateMarkup() {
...
},{"./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"fd0vu","./previewView.js":"6tKHS"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"fd0vu","./previewView.js":"6tKHS","./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"2kjY2","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["9NBY4","7dWZ8"], "7dWZ8", "parcelRequire3a11", "./", "/")
